...
class GerarPDF():
    def gerar(plano_producao, planos_venda, preco_castanha, plano_venda_amendoa_inicial, preco_amendoa_inicial):
        ...
        dados_tabela2 = [
            ["Classe", "Qtde. Amendoa(Kg)", "Estoque de Produto(Kg))"],
        ...
        dados_tabela3 = [
            ["Classe de Amêndoas",
                "Qtde. Amêndoas(Kg)", "Preço do Produto(Kg))"],
        ...
        dados_tabela4 = [
            ["Tipo de Castanha", "Qtde. castanha(Kg)", "Valor (R$/Kg)"],
            ["Pequena", 1,
                preco_castanha['precoCastpequena']],
            ["Média 1", 1,
                preco_castanha['precoCastmedia1']],
            ["Média 2", 1,
                preco_castanha['precoCastmedia2']],
            ["Grande", 1,
                preco_castanha['precoCastgrande']],
        ]

        # Estilo da tabela
        style = TableStyle([
            # Define a primeira linha com cor de fundo cinza
        ...
        titulo3 = Paragraph("Plano de Amendoa Inicial",style_title)
